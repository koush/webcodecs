...
import { fragmentYUV, vertexQuad } from './ShaderSources.js'
...
export default class YUVSurfaceShader {
  ...
  static _initShaderArgs (gl, program) {
    ...
    shaderArgs.a_texCoordChroma = program.getAttributeLocation('a_texCoordChroma')
    gl.enableVertexAttribArray(shaderArgs.a_texCoordChroma)
  ...
  updateShaderData (encodedFrameSize, h264RenderState) {
    ...
    this.gl.bufferData(this.gl.ARRAY_BUFFER, new Float32Array([
      ...
      0, 0, 0, 0, 0, 0,
      // top right:
      w, 0, h264RenderState.maxXTexCoord, 0, h264RenderState.maxXTexCoordChroma, 0,
      // bottom right:
      w, h, h264RenderState.maxXTexCoord, h264RenderState.maxYTexCoord, h264RenderState.maxXTexCoordChroma, h264RenderState.maxYTexCoordChroma,

      // Second triangle
      // bottom right:
      w, h, h264RenderState.maxXTexCoord, h264RenderState.maxYTexCoord, h264RenderState.maxXTexCoordChroma, h264RenderState.maxYTexCoordChroma,
      // bottom left:
      0, h, 0, h264RenderState.maxYTexCoord, 0, h264RenderState.maxYTexCoordChroma,
      // top left:
      0, 0, 0, 0, 0, 0,
    ]), this.gl.DYNAMIC_DRAW)
    this.gl.vertexAttribPointer(this.shaderArgs.a_position, 2, this.gl.FLOAT, false, 24, 0)
    this.gl.vertexAttribPointer(this.shaderArgs.a_texCoord, 2, this.gl.FLOAT, false, 24, 8)
    this.gl.vertexAttribPointer(this.shaderArgs.a_texCoordChroma, 2, this.gl.FLOAT, false, 24, 16)
  }
