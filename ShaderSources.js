...
export const vertexQuad = {
  ...
  attribute vec2 a_texCoordChroma;
  varying vec2 v_texCoord;
  varying vec2 v_texCoordChroma;
  void main(){
    v_texCoord = a_texCoord;
    v_texCoordChroma = a_texCoordChroma;
...
export const fragmentYUV = {
  ...
  void main(void) {
    ...
    float uChannel = texture2D(uTexture, v_texCoordChroma).x;
    float vChannel = texture2D(vTexture, v_texCoordChroma).x;
